...
const spellExpelliarmusX = [400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 796, 792, 788, 784, 780, 776, 772, 768, 764, 760];
const spellExpelliarmusY = [350, 350, 350, 350, 350, 350, 350, 350, 350, 350, 350, 385, 420, 455, 490, 525, 560, 595, 630, 665, 700];


const spells = ["Stupify", "Expelliarmus"];
let choosenSpellX = [];
let choosenSpellY = [];
...
function drawButtons(pozStartX, pozStartY, a) {
    ...
    canvas.addEventListener("mouseup", function (e) {
        if (e.clientX - leftCanvas > pozStartX + (a * (menuButtonX + 50))
            ...
            choosenSpellY = eval('spell' + spells[a] + 'Y');
            table();
        }
...
function bagietto() {
    ...
    ctx.fillStyle = "white";
    ctx.font = "15px Arial";
    ctx.fillText("START", choosenSpellX[0], choosenSpellY[0] - 20);
